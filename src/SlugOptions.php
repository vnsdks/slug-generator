...
namespace Vnsdks\SlugGenerator;
...
class SlugOptions implements \IteratorAggregate
{
    ...
    /**
     * @param $options See the setter methods for available options
     */
    ...
    /**
     * @param $transforms List of rules or rulesets to be used by the Transliterator,
     *                             like `Lower`, `ASCII` or `a > b; c > d`
     *
     * @return static
     */
    public function setTransforms($transforms): self
    {
        $this->transforms = [];
     ...
     * @return static
     */
    public function setPreTransforms($transforms): self
    {
     ...
     * @return static
     */
    public function setPostTransforms($transforms): self
    {
        foreach ($transforms as $transform) {
            $this->assertTransform($transform);
            $this->addTransform($transform, false);
    ...
    private function assertTransform($transform)
    {
        if (!is_string($transform)) {
            throw new \InvalidArgumentException(sprintf('Transform must be of the type string, %s given',
                gettype($transform)));
        }
